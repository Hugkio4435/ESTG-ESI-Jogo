...
public class MenuManager : MonoBehaviour
{
    ...
    public GameObject jogoCerteiroPanel;
    ...
    public JogoCerteiroManager jogoCerteiroManager;
    ...
    public void ShowMainMenu()
    {
        ...
        if (jogoCerteiroPanel != null) jogoCerteiroPanel.SetActive(false);
    ...
    public void StartTheGame()
    {
        ...
        if (currentSelectedGame == "JogoCerteiro")
        {
    ...
    public void HandlePlayerAction(ActionResponse actionData)
    {
        ...
        else if (jogoCerteiroPanel != null && jogoCerteiroPanel.activeInHierarchy)
        {
