...

{
...

    {
        ...
        // === A NOVA BORRACHA GLOBAL ===
        // Apaga o texto dos pontos globais para não ficarem a assombrar o próximo jogo!
...

    {
        ...
        if (leaderboardListText != null) leaderboardListText.text = "";
        // =============================
