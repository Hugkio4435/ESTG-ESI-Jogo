...
public class ScenarioData
{
    ...
    // NOVO: Regista o tempo exato que demorou a entrar o último voto
...
public class SplitRoomManager : MonoBehaviour, IMinigame
{
    ...
    // NOVO: Bónus máximo de tempo atribuível ao autor do cenário
    ...
    private void HandleTimeUp()
    {
        ...
        {
            // NOVO: Se o tempo acabar sem toda a gente votar, o autor recebe o bónus máximo de tempo!
    ...
    private void RegisterVote(string voterName, bool votedYes)
    {
        ...
        {
            // NOVO: Regista o tempo que demorou até ao último voto!
    ...
    private IEnumerator SimpleRevealCoroutine()
    {
        ...
        // ==========================================
        // NOVO: BÓNUS PROPORCIONAL DE TEMPO
        // ==========================================
        // Calcula a percentagem de tempo gasto (ex: 15s / 20s = 0.75) e multiplica pelo bónus máximo.
